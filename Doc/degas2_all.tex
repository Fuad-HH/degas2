...
global arrays described in the \href{classes.pdf#65}{statistics class} 
...
\href{classes.pdf#61}{output class} (see also
Sec.~\ref{outputformat}).
\end{description}

This process is complicated by two additional optimizations.
First, as is documented in the \href{classes.pdf#65}{statistics class},
...
as described in the \href{classes.pdf#26}{sources class}.  
...
\href{classes.pdf#61}{output arrays}.
...
and in the source \href{defineback.pdf#page13}{file}
{\tt defineback.web}).
