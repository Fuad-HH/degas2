...
anticipated spatial variations of the neutral density. In comparison, 
...
large. We will demonstrate in Sec.~\ref{cmod1d} that the temperature dependence
...
in the $x$ direction. At present, the plates have a finite extent in the $z$ 
direction with mirror boundary conditions at $z_{\rm min}$ and $z_{\rm max}$.
Periodic boundary conditions are enforced in the $y$ direction so that
the problem is effectively infinite in that direction. Eventually, the
$z$ direction will also have periodic boundary conditions. Particles
...
in about an hour using 14 400 MHz Pentium PCs). You can probably run a smaller
...
$\Pi_{xy}^{\rm fm}(T_{\rm wall}) = 0.20978$ Pa.
If we average the 10 values for $\Pi_{xy}$ in the {\tt density10.out} file, we
get $\Pi_{xy, {\rm sim}} = 0.13051$ Pa and 
\begin{equation}
\left( \frac{\Pi_{xy}}{\Pi_{xy}^{\rm fm}} \right)_{\rm sim} = 0.6215.
\end{equation}
...
4.5866 \times 10^{-21}$ J. Then, $\delta_{\sim} = 0.9393$, and
\begin{equation}
...
geometry. In particular, this run includes both neutral-ion and neutral-
neutral elastic scattering processes. The complexity of the physics also
...
example (Sec.~\ref{analyticfluidbench}).
  \item {\bf Switch to the example directory.} If the main DEGAS 2 
directory sits within your home directory:
\begin{verbatim}
...
There should always be a small remainder in the energy and momentum balances; 
its magnitude appears to roughly coincide with the accuracy provided by
...
minimum weight is $10^{-3}$ of the initial weight. The Russian roulette 
procedure is set up so as to not lose mass. However, it will conserve
momentum and energy only on the average (i.e., after many flights).
...
initial implementation of the BGK algorithm in DEGAS 2 repeats this same mistake.

To see the difference, you can modify the {\tt degas2.in} file to point to
the {\tt reactions.input} and {\tt reactions.nc} files in the data directory.
...
This error in the default rates will be corrected in a subsequent 
version of the code.

  \item {\bf Other results.} For reference purposes, 
this directory contains output files from a 
single iteration (on a Sun with \verb+DEBUG=yes+) with 1000 flights. These
...
to do this is to insert the line:
\begin{verbatim}
      bgk_iteration=FALSE
\end{verbatim}
as the last executable statement in subroutine {\tt bgk\_test} near the end
of {\tt flighttest.web}.
...
these sectors. In the first two cases, little or no input is
...
\begin{theindex}
  ...
  \item adsorption, \hyperpage{53}
  \item Allocation, memory, \hyperpage{2}
  \item Atomic physics, \hyperpage{21}

  \indexspace

  \item background species, \hyperpage{53}
  \item BGK, \hyperpage{35}
  \item Boltzmann equation, \hyperpage{1}
  \item boxgen, \hyperpage{48}

  \indexspace

  \item Charge exchange, \hyperpage{25}
  \item chargex, \hyperpage{52}
  \item collisional-radiative, \hyperpage{21}
  \item CVS, \hyperpage{3}, \hyperpage{44}

  \indexspace

  \item dataexam, \hyperpage{49}
  \item datamatch, \hyperpage{50}
  \item datasetup, \hyperpage{48}
  \item defineback, \hyperpage{46}
  \item defineback input, \hyperpage{54}
  \item definegeometry2d, \hyperpage{45, 46}
  \item definegeometry2d input, \hyperpage{54}
  \item DEGAS, \hyperpage{2}
  \item desorption, \hyperpage{53}
  \item Differential cross section, \hyperpage{25}
  \item Diffusion, \hyperpage{35}
  \item Diffusion cross section, \hyperpage{25}
  \item directories, \hyperpage{45}
  \item dissoc, \hyperpage{52}
  \item dissoc\_rec, \hyperpage{52}
  \item Distribution, probability, \hyperpage{5}

  \indexspace

  \item elastic, \hyperpage{52}
  \item Elastic scattering, \hyperpage{25}
  \item elements\_infile, \hyperpage{52}
  \item elementsfile, \hyperpage{52}
  \item Emacs, \hyperpage{43}
  \item emacs, \hyperpage{42}

  \indexspace

  \item flighttest, \hyperpage{46}
  \item ftangle, \hyperpage{43}
  \item fweave, \hyperpage{43}
  \item FWEB, \hyperpage{2}, \hyperpage{43}

  \indexspace

  \item Generators, random number, \hyperpage{5}
  \item generic, \hyperpage{52}
  \item generic PMI, \hyperpage{53}
  \item generic reactions, \hyperpage{52}
  \item geometry.inp, \hyperpage{55}
  \item geomtesta, \hyperpage{46}
  \item gmake, \hyperpage{42}

  \indexspace

  \item HDF, \hyperpage{3}, \hyperpage{44}
  \item HOME, \hyperpage{45}

  \indexspace

  \item ionization, \hyperpage{21}
  \item ionize, \hyperpage{52}
  \item ionize\_suppress, \hyperpage{52}

  \indexspace

  \item LaTeX, \hyperpage{43}

  \indexspace

  \item Macros, \hyperpage{2}
  \item make, \hyperpage{42}
  \item Makefile, \hyperpage{42}
  \item Makefile.local, \hyperpage{45}
  \item matcheir, \hyperpage{50}
  \item matchout, \hyperpage{50}
  \item materials\_infile, \hyperpage{53}
  \item materialsfile, \hyperpage{53}
  \item Maxwell molecules, \hyperpage{35}
  \item Monte Carlo, \hyperpage{5}

  \indexspace

  \item ncdum, \hyperpage{43}
  \item ncdump-filter, \hyperpage{43}
  \item ncgen, \hyperpage{43}
  \item ncgen-filter, \hyperpage{43}
  \item NetCDF, \hyperpage{3}
  \item netCDF, \hyperpage{43}
  \item Neutral Transport, \hyperpage{1}
  \item Neutral-ion scattering, \hyperpage{25}
  \item Neutral-neutral scattering, \hyperpage{35}
  \item non-generic PMI, \hyperpage{53}
  \item non-generic reactions, \hyperpage{52}

  \indexspace

  \item Object oriented programming, \hyperpage{2}
  \item outputscript, \hyperpage{55}

  \indexspace

  \item Pcl-cvs, \hyperpage{44}
  \item PMI, \hyperpage{53}
  \item pmi\_infile, \hyperpage{53}
  \item pmitest, \hyperpage{49}
  \item pmiwrite, \hyperpage{48}
  \item problem\_infile, \hyperpage{53}
  \item problemfile, \hyperpage{53}
  \item problemsetup, \hyperpage{46}
  \item Processing, parallel, \hyperpage{3}

  \indexspace

  \item Random, \hyperpage{5}
  \item randomtest, \hyperpage{49}
  \item ratecalc, \hyperpage{48}
  \item rates, atomic physics, \hyperpage{21}
  \item reaction type, \hyperpage{52}
  \item reaction\_infile, \hyperpage{52}
  \item reactionfile, \hyperpage{52}
  \item reactiontest, \hyperpage{49}
  \item reactionwrite, \hyperpage{48}
  \item readbackground, \hyperpage{46}
  \item readbackground input, \hyperpage{54}
  \item readgeometry, \hyperpage{46}
  \item readgeometry input, \hyperpage{54}
  \item recombination, \hyperpage{21}, \hyperpage{52}
  \item reference level, \hyperpage{53}
  \item reflection, \hyperpage{53}

  \indexspace

  \item Scattering angle, \hyperpage{25}
  \item Scoring, \hyperpage{5}
  \item sourcetest, \hyperpage{49}
  \item species, \hyperpage{52}
  \item species\_infile, \hyperpage{52}
  \item speciesfile, \hyperpage{52}
  \item Spin exchange, \hyperpage{25}
  \item subset data, \hyperpage{53}
  \item symbolic name, \hyperpage{51}
  \item sysdeptest, \hyperpage{49}

  \indexspace

  \item Tags, \hyperpage{42}
  \item tally, \hyperpage{54}
  \item tally\_infile, \hyperpage{54}
  \item tallyfile, \hyperpage{54}
  \item tallysetup, \hyperpage{46}, \hyperpage{54}
  \item test species, \hyperpage{53}
  \item TeX, \hyperpage{43}
  \item Theory, transport, \hyperpage{1}
  \item Total cross section, \hyperpage{25}
  \item Tracking, \hyperpage{5}
  \item Transport codes, \hyperpage{1}
  \item Triangle, \hyperpage{45}

  \indexspace

  \item Viscosity, \hyperpage{35}
  \item Viscosity cross section, \hyperpage{25}
