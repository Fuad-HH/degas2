...
Release V.\ 4.5\thanks{This file is written in \TeX. 
A hyper-linked PDF
...
that came with the code. Copyright \copyright 2012 PPPL.
...
set the controlling
parameters in the \href{classes.pdf#page.25}{source class}.
...
\href{classes.pdf#page.128}{snapshot class}.  With this
...
\end{verbatim}
  \item {\bf Prepare reference data.}
This example does use a modified PMI file that removes H as a 
product in desorption from C.  Consequently, this step must be
performed even if the standard reference data files in the
data directory have been previously created.  The resulting
{\tt pmi.nc} file will remain in the run directory and will not
affect other runs utilizing the reference data.
\begin{verbatim}
gmake datasetup
./datasetup
\end{verbatim}
...
The two techniques available now are
  \begin{itemize}
...
{\tt readgeometry}, {\tt boxgen}, or {\tt btopdetector}.

\subsection{Signal Computation}

The contribution from each zone to a view is usually precomputed so that the
signal can be quickly determined
during or after the run from volumetric emission. However, this can
...
of chords during geometry setup and save processing the full array
for postprocessing. The chord signals can be individually evaluated,
...
\begin{theindex}
  ...
  \item adsorption, \hyperpage{61}
  \item Allocation, memory, \hyperpage{3}
  \item Atomic physics, \hyperpage{24}

  \indexspace

  \item background species, \hyperpage{61}
  \item BGK, \hyperpage{42}
  \item Boltzmann equation, \hyperpage{1}
  \item boxgen, \hyperpage{55}

  \indexspace

  \item Carre, \hyperpage{58}, \hyperpage{88}
  \item Charge exchange, \hyperpage{32}
  \item chargex, \hyperpage{60}
  \item checkpoints, \hyperpage{99}
  \item collisional-radiative, \hyperpage{24}
  \item CVS, \hyperpage{4}, \hyperpage{51}

  \indexspace

  \item dataexam, \hyperpage{56}
  \item datamatch, \hyperpage{57}
  \item datasetup, \hyperpage{55}
  \item defineback, \hyperpage{23}, \hyperpage{53}, \hyperpage{88}
  \item defineback input, \hyperpage{62}
  \item definegeometry2d, \hyperpage{51}, \hyperpage{53}, 
		\hyperpage{88}
  \item definegeometry2d input, \hyperpage{62}
  \item DEGAS, \hyperpage{2}
  \item desorption, \hyperpage{61}
  \item DG, \hyperpage{58}, \hyperpage{88}
  \item Differential cross section, \hyperpage{32}
  \item Diffusion, \hyperpage{42}
  \item Diffusion cross section, \hyperpage{32}
  \item directories, \hyperpage{52}
  \item dissoc, \hyperpage{60}
  \item dissoc\_rec, \hyperpage{60}
  \item Distribution, probability, \hyperpage{5}

  \indexspace

  \item elastic, \hyperpage{60}
  \item Elastic scattering, \hyperpage{32}
  \item elements\_infile, \hyperpage{60}
  \item elementsfile, \hyperpage{60}
  \item Emacs, \hyperpage{49}
  \item emacs, \hyperpage{49}

  \indexspace

  \item flighttest, \hyperpage{53}
  \item ftangle, \hyperpage{50}
  \item fweave, \hyperpage{50}
  \item FWEB, \hyperpage{3}, \hyperpage{50}

  \indexspace

  \item Generators, random number, \hyperpage{5}
  \item generic, \hyperpage{60}
  \item generic PMI, \hyperpage{61}
  \item generic reactions, \hyperpage{60}
  \item geometry.inp, \hyperpage{63}
  \item geomtesta, \hyperpage{53}
  \item gmake, \hyperpage{49}

  \indexspace

  \item HDF, \hyperpage{4}, \hyperpage{51}
  \item HDF5, \hyperpage{51}
  \item HOME, \hyperpage{52}

  \indexspace

  \item ionization, \hyperpage{24}
  \item ionize, \hyperpage{60}
  \item ionize\_suppress, \hyperpage{60}

  \indexspace

  \item LaTeX, \hyperpage{50}

  \indexspace

  \item Macros, \hyperpage{3}
  \item make, \hyperpage{49}
  \item Makefile, \hyperpage{49}
  \item Makefile.local, \hyperpage{52}
  \item matcheir, \hyperpage{57}
  \item matchout, \hyperpage{57}
  \item materials\_infile, \hyperpage{61}
  \item materialsfile, \hyperpage{61}
  \item Maxwell molecules, \hyperpage{42}
  \item Monte Carlo, \hyperpage{5}

  \indexspace

  \item ncdum, \hyperpage{49}
  \item ncdump-filter, \hyperpage{49}
  \item ncgen, \hyperpage{49}
  \item ncgen-filter, \hyperpage{49}
  \item NetCDF, \hyperpage{4}
  \item netCDF, \hyperpage{49}
  \item Neutral Transport, \hyperpage{1}
  \item Neutral-ion scattering, \hyperpage{32}
  \item Neutral-neutral scattering, \hyperpage{42}
  \item non-generic PMI, \hyperpage{61}
  \item non-generic reactions, \hyperpage{60}

  \indexspace

  \item Object oriented programming, \hyperpage{3}
  \item outputscript, \hyperpage{63}

  \indexspace

  \item Pcl-cvs, \hyperpage{51}
  \item PMI, \hyperpage{61}
  \item pmi\_infile, \hyperpage{61}
  \item pmitest, \hyperpage{56}
  \item pmiwrite, \hyperpage{55}
  \item problem\_infile, \hyperpage{61}
  \item problemfile, \hyperpage{61}
  \item problemsetup, \hyperpage{53}
  \item Processing, parallel, \hyperpage{4}

  \indexspace

  \item Random, \hyperpage{5}
  \item randomtest, \hyperpage{56}
  \item ratecalc, \hyperpage{55}
  \item rates, atomic physics, \hyperpage{24}
  \item reaction type, \hyperpage{60}
  \item reaction\_infile, \hyperpage{60}
  \item reactionfile, \hyperpage{60}
  \item reactiontest, \hyperpage{56}
  \item reactionwrite, \hyperpage{55}
  \item readbackground, \hyperpage{53}
  \item readbackground input, \hyperpage{62}
  \item readgeometry, \hyperpage{53}
  \item readgeometry input, \hyperpage{62}
  \item recombination, \hyperpage{24}, \hyperpage{60}
  \item reference level, \hyperpage{61}
  \item reflection, \hyperpage{61}
  ...
  \item Silo, \hyperpage{51}
  \item snapshot, \hyperpage{23}
  \item sourcetest, \hyperpage{56}
  \item species, \hyperpage{60}
  \item species\_infile, \hyperpage{60}
  \item speciesfile, \hyperpage{60}
  \item Spin exchange, \hyperpage{32}
  \item subset data, \hyperpage{61}
  \item symbolic name, \hyperpage{59}
  \item sysdeptest, \hyperpage{56}

  \indexspace

  \item Tags, \hyperpage{49}
  \item tally, \hyperpage{63}
  \item tally\_infile, \hyperpage{63}
  \item tallyfile, \hyperpage{63}
  \item tallysetup, \hyperpage{53}, \hyperpage{63}
  \item test species, \hyperpage{61}
  \item TeX, \hyperpage{50}
  ...
  \item Triangle, \hyperpage{51}

  \indexspace

  \item ucd\_plot, \hyperpage{53}
