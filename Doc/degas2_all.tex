...
%   gmake codefile.tex
%   pdflatex codefile.tex (may need to be done twice)
%   mv codefile.pdf ../Doc
% update page numbers in href's to these files.  Also, the DEGAS 2
...
Release V.\ 4.3\thanks{This file is written in \TeX. 
A hyper-linked PDF
...
that came with the code. Copyright \copyright 2009 PPPL.
...
See the 
\href{classes.pdf#page.34}{sector class} documentation for a more
...
\href{http://www.unidata.ucar.edu/software/netcdf/}{http://www.unidata.ucar.edu/software/netcdf/}.  The version presently being used for DEGAS 2 development
is 3.6.3. 
...
PDF file. The \href{classes.pdf#page.49}{tally class} contains more 
...
in about an hour using 10 1.7 GHz AMD Athlon PCs). 
...
repeated this same mistake.

% NOTE: have not made these changes to the code yet!

To see the difference, you can modify the {\tt degas2.in} file to point to
the {\tt reactions.input} and {\tt reactions.nc} files in this directory;
these use the old versions of the neutral-neutral data files that are
also in this directory.
When you run the code again (you at least need to rerun {\tt problemsetup}
first), you will find something like the results contained in 
{\tt bgkbalances\_default.out}:
\begin{tabbing}
  mom. 1 to \verb+D+: \= xx $-9.39835 \times 10^{-3}$ xx \=  
mom. 1 to \verb+D2+: \= xx $+9.19450 \times 10^{-3}$ \kill
...
\href{classes.pdf#page.126}{geometry2d class documentation}).
...
\href{classes.pdf#page.75}{PMI format class}.
...
(see the \href{classes.pdf#page.75}{PMI format class}).
...
\href{classes.pdf#page.46}{detector class}.
...
\begin{theindex}
  ...
  \item Atomic physics, \hyperpage{23}
  ...
  \item collisional-radiative, \hyperpage{23}
  ...
  \item defineback, \hyperpage{53}, \hyperpage{88}
  ...
  \item outputscript, \hyperpage{62}
  ...
  \item rates, atomic physics, \hyperpage{23}
  ...
  \item recombination, \hyperpage{23}, \hyperpage{60}
  ...
  \item tally, \hyperpage{62}
  \item tally\_infile, \hyperpage{62}
  \item tallyfile, \hyperpage{62}
  \item tallysetup, \hyperpage{53}, \hyperpage{62}
