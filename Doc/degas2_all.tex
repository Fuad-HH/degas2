...
% problemsetup, outputbrowser, definegeometry2d, defineback:
%   gmake codefile.tex
...
CVS $Revision$
\thanks{This file is written in \TeX. 
A hyper-linked PDF
file is generated from that source using {\tt pdflatex}. The version number 
here is the CVS version number for the User's Manual itself.  This document
is now distributed as part of the DEGAS 2 code. The user can be best assured
of concurrence between code and manual by referring to the version of the manual
that came with the code. Copyright \copyright 2001 PPPL.
...
gives relatively insight into the problem being studied. Yet, when the
...
netCDF (see Sec.~\ref{netcdf}) can be obtained from  
...
FWEB (version 1.62) (see Sec.~\ref{fweb}) is available at
...
used only by the {\tt geomtesta} utility as a convenient format for transferring
the code results in graphical form for processing by commercial products.
...
is \href{http://www.cs.cmu.edu/~quake/triangle.html}{http://www.cs.cmu.edu/~quake/triangle.html} 
The {\tt Triangle} V. 1.3 was used in writing {\tt definegeometry2d}.
...
\item[definegeometry2d] Generates a DEGAS 2 netCDF geometry file from from a text
...
able to read data produced by the {\tt DG} package (part of the {\tt B2-Eirene} or
{\tt SOLPS} distribution) or by UEDGE. Of the three tools for setting up
...
produced by other codes. However, {\tt defineback} is not yet mature
and is, consequently, a little ``rough around the edges''.
...
line.See Sec.(the same physics benchmark).
...
\item Linux, NAG F95, Portland Group F90, and Lahey-Fujitsu F95 compilers 
[{\tt LINUX}], (The code will work with the Lahey-Fujitsu compiler, but
may run very slowly. This will likely be remedied in a subsequent version
of the compiler.)
...
\begin{theindex}
  ...
  \item defineback, \hyperpage{53}
  \item defineback input, \hyperpage{61}
  \item definegeometry2d, \hyperpage{52, 53}
  \item definegeometry2d input, \hyperpage{61}
  \item DEGAS, \hyperpage{2}
  \item desorption, \hyperpage{60}
  ...
  \item dissoc, \hyperpage{59}
  \item dissoc\_rec, \hyperpage{59}
  \item Distribution, probability, \hyperpage{5}

  \indexspace

  \item elastic, \hyperpage{59}
  \item Elastic scattering, \hyperpage{32}
  \item elements\_infile, \hyperpage{59}
  \item elementsfile, \hyperpage{59}
  ...
  \item generic, \hyperpage{59}
  \item generic PMI, \hyperpage{60}
  \item generic reactions, \hyperpage{59}
  \item geometry.inp, \hyperpage{62}
  ...
  \item ionize, \hyperpage{59}
  \item ionize\_suppress, \hyperpage{59}
  ...
  \item materials\_infile, \hyperpage{60}
  \item materialsfile, \hyperpage{60}
  ...
  \item non-generic PMI, \hyperpage{60}
  \item non-generic reactions, \hyperpage{59}
  ...
  \item PMI, \hyperpage{60}
  \item pmi\_infile, \hyperpage{60}
  \item pmitest, \hyperpage{56}
  \item pmiwrite, \hyperpage{55}
  \item problem\_infile, \hyperpage{60}
  \item problemfile, \hyperpage{60}
  ...
  \item reaction type, \hyperpage{59}
  \item reaction\_infile, \hyperpage{59}
  \item reactionfile, \hyperpage{59}
  \item reactiontest, \hyperpage{56}
  \item reactionwrite, \hyperpage{55}
  \item readbackground, \hyperpage{53}
  \item readbackground input, \hyperpage{61}
  \item readgeometry, \hyperpage{53}
  \item readgeometry input, \hyperpage{61}
  \item recombination, \hyperpage{23}, \hyperpage{59}
  \item reference level, \hyperpage{60}
  \item reflection, \hyperpage{60}
  ...
  \item species, \hyperpage{59}
  \item species\_infile, \hyperpage{59}
  \item speciesfile, \hyperpage{59}
  \item Spin exchange, \hyperpage{32}
  \item subset data, \hyperpage{60}
  \item symbolic name, \hyperpage{58}
  \item sysdeptest, \hyperpage{56}

  \indexspace

  \item Tags, \hyperpage{49}
  \item tally, \hyperpage{61}
  \item tally\_infile, \hyperpage{61}
  \item tallyfile, \hyperpage{61}
  \item tallysetup, \hyperpage{53}, \hyperpage{61}
  \item test species, \hyperpage{60}
