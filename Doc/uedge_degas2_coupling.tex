...
% Note: to remove page number from first page, alter article.sty file
%       to use \pagestyle{empty} in the section related to \maketitle
% Date Convention: It looks like they arrange first by journal publication date,
% except for conferences. These are arranged according to the meeting date. Note
% that PSI (-> J. Nucl. Mater.) goes by the journal date.
% 
% Update 3/12/99. Have abandoned MS Word version.
%\pagestyle{headings}
\begin{document}
