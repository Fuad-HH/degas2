...
def generateGeometryFromEFITfile(efitfile,mat,recyc_coef=1.0,Twall=300.0,wfilename="wallfile.txt"):
    ...
    psi_func = interpolate.interp2d(r_1d, z_1d, np.transpose(psi_rz), kind='cubic')
    ...
    polys,wall,rsep,sep=write_dg2d_input_from_single_wall(wfilename,mat,recyc_coef,walltemp=Twall,minarea=-1.0,dg2dfile_name="dg2d.in",polygon_filename="polygons.nc",debug=False,exitnodes=[])
