 ...
 created with UNIX on "Friday, September 25, 1998 at 8:02." \
  ...
  RUN TIME:     "Wednesday, September 20, 2017 at 15:35."\
  WEB FILE:     "./common.web"\
  CHANGE FILE:  (none)
#endif
#define _COMMON_h  
...
/* :349 */
/* 350: */
#line 9292 "./common.web"


char*
strnmove FCN((s1,s2,n))
char*s1 C0("Destination.")
CONST char*s2 C0("Source.")
size_t n C1("String size.")
