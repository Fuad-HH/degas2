...
#ifdef CHORDZ /* add z to struct _Chord */
  double z1,z2;
#endif
};
...
#ifdef CHORDZ /* declare AddChord3D and ChangeChord3D */
...
#ifdef CHORDEXT /* declare TlExtChord */
...
#ifdef CHORDEXT /* declare ExtendChord */
